...
import { Lightbulb, Plus, Edit2, Trash2, X, Save, FileText, Loader2 } from 'lucide-react';
...
const ArticlesTab: React.FC = () => {
  ...
  const handleDelete = async (id: number) => { if (confirm("Видалити?")) { await supabase.from('articles').delete().eq('id', id); fetchArticles(); } };
